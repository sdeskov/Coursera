...
def get_hours(seconds):
    ...
    Returns the number of hours elapsed since midnight, as seen
    on a 24-hour clock. The parameter is a number of seconds since midnight.
...
def get_minutes(seconds):
    ...
    in the range 0 to 59, inclusive. The parameter is a number of
...
def time_to_utc(utc_offset, time):
    ...
    UTC+0. The second parameter is a time in that time zone.
    ...
    utc_0_time = time - utc_offset
    return round(to_24_hour_clock(utc_0_time), 2)
...
def time_from_utc(utc_offset, time):
    ...
    The first parameter is a UTC offset specifying
    a time zone and the second parameter is a time
    in time zone UTC+0. Return the equivalent time
    ...
    return round(to_24_hour_clock(utc_time), 2)
